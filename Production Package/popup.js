class UXIssueTracker {
    constructor() {
        console.log('🚀 POPUP: Constructor called - initializing UXIssueTracker');
        this.currentStep = 1;
...
document.addEventListener('DOMContentLoaded', () => {
    try {
        console.log('Initializing UX Issue Tracker...');
        const tracker = new UXIssueTracker();
        console.log('UX Issue Tracker initialized successfully');
    } catch (error) {
        console.error('Failed to initialize UX Issue Tracker:', error);
